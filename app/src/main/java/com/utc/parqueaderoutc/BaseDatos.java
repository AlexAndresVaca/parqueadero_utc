...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    private static final int versionBddParqueadero = 1;// version de base de Datos
    private static final String nombreBddParqueadero = "app_parqueadero";// Nombre de Base de Datos
    ...
    public BaseDatos(Context contexto) {
        super(contexto, nombreBddParqueadero, null, versionBddParqueadero);
    }
